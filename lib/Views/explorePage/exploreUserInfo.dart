...
import 'package:project_phase_one/Views/explorePage/writeNewText.dart';
import '../Widgets.dart';
              ...
              child: Column(
                children: [
                  Row(children: [
                      ...
                      SizedBox(width: 180, height: 200, child: Text(user.bio,overflow: TextOverflow.ellipsis,maxLines: 12,),
                      )
                    ],
                  ),
